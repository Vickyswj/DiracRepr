...
super ((M0 ⊗ M0 ⊗ I_2) × (H ⊗ I_2 ⊗ I_2) × (CX ⊗ I_2)) (((φ a b) ⊗ bell00) × ((φ a b) ⊗ bell00)†) ≡ (/ 2  .* ∣0⟩ ⊗ ∣0⟩ ⊗ (φ a b)) × (/ 2  .* ∣0⟩ ⊗ ∣0⟩ ⊗ (φ a b))†.
Proof.
...
super ((I_2 ⊗ I_2 ⊗ σX) × (M0 ⊗ M1 ⊗ I_2) × (H ⊗ I_2 ⊗ I_2) × (CX ⊗ I_2)) ((φ a b⊗ bell00) × (φ a b⊗ bell00)†) ≡ (/ 2  .* ∣0⟩ ⊗ ∣1⟩ ⊗ (φ a b)) × (/ 2  .* ∣0⟩ ⊗ ∣1⟩ ⊗ (φ a b))†.
Proof.
intros. unfold bell00,φ,super.
super_reduce.
repeat rewrite coefficient.
...
super ((I_2 ⊗ I_2 ⊗ σZ) × (M1 ⊗ M0 ⊗ I_2) × (H ⊗ I_2 ⊗ I_2) × (CX ⊗ I_2)) ((φ a b⊗ bell00) × (φ a b⊗ bell00)†) ≡ (/ 2  .* ∣1⟩ ⊗ ∣0⟩ ⊗ (φ a b)) × (/ 2  .* ∣1⟩ ⊗ ∣0⟩ ⊗ (φ a b))†.
Proof.
intros. unfold bell00,φ,super.
super_reduce.
repeat rewrite coefficient.
...
super ((I_2 ⊗ I_2 ⊗ σZ) × (I_2 ⊗ I_2 ⊗ σX) × (M1 ⊗ M1 ⊗ I_2) × (H ⊗ I_2 ⊗ I_2) × (CX ⊗ I_2)) ((φ a b⊗ bell00) × (φ a b⊗ bell00)†) ≡ (/ 2  .* ∣1⟩ ⊗ ∣1⟩ ⊗ (φ a b)) × (/ 2  .* ∣1⟩ ⊗ ∣1⟩ ⊗ (φ a b))†.
Proof.
intros. unfold bell00,φ,super.
super_reduce.
repeat rewrite coefficient.
